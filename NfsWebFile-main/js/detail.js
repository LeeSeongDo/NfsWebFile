...
// 💡 궁극의 데이터 패칭 함수: 상세 페이지도 다중 통로로 보호합니다.
...
async function fetchPerformanceDetail(id) {
    ...
    try {
        ...
        introImagesHtml = `<img src="https://via.placeholder.com/800x400?text=Test+Intro+Image" class="w-full max-w-3xl mb-4 rounded-2xl shadow-sm">`;
    }
